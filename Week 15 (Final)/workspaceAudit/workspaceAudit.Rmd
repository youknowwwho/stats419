---
title: 'R Notebook: Workspace Audit for [Connor StarrHurst]'
output:
  html_document:
    df_print: paged
    toc: true
...
```{r}
wsu.id = "connor_starrhurst"; # change this to yours.
github.repository = "youknowwwho/stats419";
...
<div>**Source: <a href="https://github.com/youknowwwho/stats419/graphs/code-frequency">GitHub</a>**</div>
...
<div>**Source: <a href="https://github.com/youknowwwho/stats419/graphs/commit-activity">GitHub</a>**</div>


## General Workspace Environment Data
```{r}
path.to.git.local = "C:/Users/Connor/.ssh/stats419/"; # C:/_git_/WSU_STATS419_FALL2020/
setwd(path.to.git.local);

path.to.git.final = paste0(path.to.git.local,"Week 15 (Final)/workspaceAudit/"); #workspaceAudit/
```
...
Now type: `git log --shortstat --pretty=format:'%h|%t|%p|%ai|%ae|%an|%ci|%ce|%cn|%N|%f|%s|%b' | paste - - - > "Week 15 (Final)/workspaceAudit/git-history.log"` which will create a file with your git history as a text file.  We will import and perform a basic graph.
...
I deserve 50/50 points because I have installed R, RStudio, Latex, various packages, Git Bash and I feel I'm able to use these programs well. All my work is on Github and updated with the current class work. I also have Dropbox basic installed (see screenshots above). After viewing the above graphs I noticed most of my activity is in the middle and later weeks, later in the day (makes sense since I do most of my work after lunch), and weeks of the year is mostly uniform.
</pre>
