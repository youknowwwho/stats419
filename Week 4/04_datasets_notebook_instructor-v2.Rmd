...
# my latest version of these functions will simplify the "date-manipulation" to just one function
```
...
for(i in 1:20)
  {
  # every loop make it 1000 times larger. notice I am looping over "i" but not using it.
...
## CS purists say it will fail eventually. maybe I have to use a smaller n to demo failure?
...
## by fail, I mean the "two-pass" approach and built ?sd or ?var function shows something entirely different
```
...
# some of you were having issues with the IMDB web connection. I was annoyed rvest doesn't cache here is a hack using dput

# http://md5.mshaffer.com/WSU_STATS419/denzel
# http://md5.mshaffer.com/WSU_STATS419/will

# I will be building out a IMDB dataset for our use to perform multivariate analyses without relying on IMDB
```
