...
measure.df.numeric = measure.df[sapply(measure.df, is.numeric)]; #Help From:
#https://www.statology.org/calculate-mean-multiple-columns-in-r/#:~:text=Often%20you%20
#may%20want%20to,using%20the%20colMeans()%20function.
...
myData = as.matrix(measure.df.numeric[-c(2:3,5:8,10)]);  #numeric values minus 
#head.height (2), head.circumference (3), navel.floor (5), age (6) quality (7), 
#minutes (8), and hand.width (10)
...
buildLatexCorrelationTable(myData, 
  ...
  myNames = c("Height (cm)", "Arm Span (cm)", "Hand Length (cm)", "Hand to Elbow (cm)", 
              "Elbow to Armpit (cm)", "Arm Reach (cm)", "Foot Length (cm)", 
              "Floor to Kneepit (cm)", "Floor to Hip (cm)", "Floor to Armpit (cm)"),
