...
measure.df.numeric = measure.df[sapply(measure.df, is.numeric)];
...
myData = as.matrix(measure.df.numeric[c(3,4,7,22,25:27,36,37)]);  #numeric values minus 
#but only including height(3), head height(4), navel to floor(7), armpit to elbow(22), 
#kneepit to floor(25), hip to floor(26), armpit to floor(27), torso height(36), # of heads 
#in height(37)
...
buildLatexCorrelationTable(myData, 
  ...
  myNames = c("Height (cm)", "Head Height (cm)", "Navel to Floor (cm)",
              ...
              "Armpit to Floor (cm)", "Torso Height (cm)", "Heads"),
