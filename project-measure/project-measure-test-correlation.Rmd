...
path.project = "C:/Users/Connor/.ssh/stats419/project-measure/";
...
buildLatexCorrelationTable(myData, 
  rotateTable = FALSE,
  width.table = 0.95, # best for given data. = 0.95 when rotateTable = FALSE. 0.60 when 
                      # rotateTable = TRUE
...
buildLatexCorrelationTable(myData, 
  rotateTable = FALSE,
  width.table = 1.1, #.95 default
  myFile = file.correlation,
  myNames = c("Diameter (in)", "Height (ft)", "Volume (ft$^3$)", "Diameter (in)", 
